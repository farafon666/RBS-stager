...
export function AssessmentWindowInProcessView(){
    return { 
      ...
      id: "windowInProcessAssessment",
      close: true,
      modal: true,
      body:{
        view:"form",
        id:"formInProcessAssessment",
        width: 1200,
        height: 730,
        elements:[
          { view:"label", label:"Дата: ",            id:"dateInProcessAssessment", name: "date"},
          { view:"label", label:"Состояние: ",       id:"statusInProcessAssessment", name: "state"},
          { view:"label", label:"Распорядитель: ",   id:"disposerInProcessAssessment", name: "disposer"},
          { view:"label", label:"Присутствующие сотрудники: "},
          {
            view:"datatable",
            id:"employeesInProcessAssessment",
            name:"employees",
            height:150,
            scroll:true,
            columns:[
